...
fbq('track', 'PageView');
      ...
      <title>AI Trading Masterclass - Registration Confirmed</title>
      <meta
        name="description"
        content="Thank you for registering for the AI Indicator Trading Strategies masterclass with Prabhu Selvaraj Sir. Join the WhatsApp group to get started."
      ></meta>
      <main>
        <div className="min-h-screen bg-gradient-to-br from-teal-400 to-teal-300 flex flex-col justify-between items-center px-4 py-10">
          <div>
            ...
            <p className="text-lg sm:text-xl text-center text-black mb-6">
              You have <span className="font-semibold">successfully reserved your seat</span> for the <span className="font-semibold text-orange-500">AI Indicator Trading Strategies</span> Masterclass with <span className="font-semibold">Prabhu Selvaraj Sir</span>.
            </p>
          </div>
          ...
          <p className="text-xl sm:text-2xl font-bold text-white text-center mt-2">
            ...
            Jumping into the AI Trading Masterclass
          </p>
        </div>
      </main>
